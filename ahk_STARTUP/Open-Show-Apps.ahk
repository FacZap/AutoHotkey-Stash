...
; F7 - Open||Show "Windows store Calculator app"
...
+F8::
    ; Check if active window is Firefox
    WinGetClass, activeClass, A
    if (activeClass = "MozillaWindowClass") {
        return
    }

    ; Otherwise, run your Gmail Chrome App logic
    OpenOrShowAppBasedOnWindowTitle("Gmail", "C:\Program Files\Google\Chrome\Application\chrome.exe --app=https://mail.google.com/mail/")
return

<^F8:: Run, https://web.whatsapp.com/
